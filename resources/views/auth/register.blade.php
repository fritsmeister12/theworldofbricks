        ...
        {{-- <div class="max-w-md w-full space-y-8">
            <div>
                ...
                <p class="mt-2 text-center text-sm text-gray-600">
                    Of
                    <a href="{{ route('login') }}" class="font-medium text-yellow-500 hover:text-yellow-600"> log in op je
                        account</a>
                </p>
            </div>
                        ...
                        <form action="#" class="mt-8 grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" id="FirstName" name="first_name"
                                    class="mt-1 w-full rounded border-gray-200 bg-white text-sm text-gray-700 shadow-sm dark:border-gray-700 dark:bg-gray-700/80 p-2 dark:text-gray-200" />
                            </div>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="password" id="PasswordConfirmation" name="password_confirmation"
                                    class="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm  dark:border-gray-700 dark:bg-gray-700/80 p-2 dark:text-gray-200" />
                            </div>
