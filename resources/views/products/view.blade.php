...
@section('content')
    <div class="mx-auto container px-6 mt-6 dark:text-white">
        ...
        <div class="row">
            ...
            <a href="{{ url('checkout', $product->id) }}">Huren</a>
        </div>
    </div>
        ...
        <div class="pt-6">
            ...
            <div class="flex justify-start flex-col items-start space-y-2">
                <button class="flex flex-row items-center text-gray-600 dark:text-white hover:text-gray-500 space-x-1">
                    ...
                    <a href="{{ route('products.index') }}" class="text-sm leading-none">Back</a>
                </button>
                ...
                <div class="mt-4 lg:mt-0 lg:row-span-3">
                    ...
                    <form class="mt-10">
                        ...
                        <a href="{{ url('checkout', $product->id) }}"
                            class="mt-10 w-full bg-indigo-600 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Huren</a>
                    </form>
                </div>
                    ...
                    <div class="mt-10">
                        ...
                        <div class="mt-4">
                            <ul role="list" class="pl-4 list-disc text-sm space-y-2">
                                ...
                                <li class="text-gray-400"><span class="text-gray-600">Lengte: {{ $product->length }}
                                        cm,
                                        Breedte: {{ $product->width }} cm, Hoogte: {{ $product->height }} cm</span>
                                </li>
