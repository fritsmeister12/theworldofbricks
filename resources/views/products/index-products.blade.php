                                ...
                                <div
                                    ...
                                    <div class="px-5 mb-4">
                                        ...
                                        <div class="grid grid-cols-2 gap-4">
                                                <a href="#"
                                                class="col-span-1 text-white bg-yellow-400 hover:bg-yellow-500 transition focus:ring-4 focus:outline-none focus:ring-yellow-400 font-medium rounded text-sm px-2 py-2.5 text-center dark:bg-yellow-400 dark:hover:bg-yellow-400 dark:focus:ring-yellow-400">Lees meer</a>
                                                <a href="#"
                                                    class="col-span-1 text-yellow-400 border hover:text-white border-yellow-400 hover:bg-yellow-400 transition focus:ring-4 focus:outline-none focus:ring-yellow-400 font-medium rounded text-sm px-2 py-2.5 text-center dark:bg-yellow-400 dark:hover:bg-yellow-400 dark:focus:ring-yellow-400">In Winkelwagen</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
