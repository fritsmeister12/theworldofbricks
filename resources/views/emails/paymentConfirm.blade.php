        ...
        <tr>
            <td class="container"
                ...
                <table style="width:100% !important;border-collapse:collapse;">
                    <tr>
                        <td class="preheader" style="font-size: 10px;color:#adadad;text-align:center; padding:5px;">This
                            is your order confirmation.</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="content"
                            ...
                            <p style="font-size:14px;font-weight:normal;margin-bottom:20px;">Hallo Smiles Davis,</p>

                            <p style="font-size:14px;font-weight:normal;margin-bottom:20px;">Thank you for your order! A
                                record of your purchase information appears below. Please keep this email as the
                                confirmation of your order.</p>

                            <p style="font-size:18px;font-weight:bold;margin-bottom:20px;">ORDER INFORMATION</p>

                            <p style="font-size:14px;font-weight:normal;margin-bottom:20px;">Order Date:
                                2018-01-01<br>Order ID: SmilesDavis-65000RGE-DVS6500500<br>Paid with: Credit card - Visa
                                ending in 6500</p>
                            ...
                            <table style="width: 90% margin: 0 auto; margin-bottom: 20px;">
                                <tr style="background-color: #eeeeee;">
                                    ...
                                    <th style="font-size:13px;font-weight:bold;text-align:right;padding: 3px 6px;"
                                        width="30%" align="right">Next Billing Date</th>
                                </tr>
                                ...
                                <tr style="border-bottom: solid 1px #f7f7f7;">
                                    <td style="font-size:13px;font-weight:normal;padding: 0px 6px;vertical-align:top;">
                                        SmilesDavis.yeah<ul
                                            style="margin-left: 20px;font-size:13px;font-weight:normal;list-style-type: none;">
                                            <li>1 year - domain renewal</li>
                                        </ul>
                                    </td>
                                    <td style="font-size:13px;font-weight:normal;padding: 0px 6px;vertical-align:top;"
                                        align="right">2019-01-01</td>
                                </tr>
                            ...
                            <p style="font-size:14px;font-weight:normal;margin-bottom:20px;">If you have questions about
                                this order, you can simply reply to this email with your questions and we will get back
                                to you shortly with an answer. You can access a printable receipt for all of your Hover
                                transactions in <a href="https://www.hover.com/signin">your Hover account</a>.</p>

                            <p style="font-size:14px;font-weight:normal;margin-bottom:20px;">Thanks again for your
                                business! We appreciate that you've chosen us.</p>

                            <!-- signature begin -->
                            <p style="font-size:14px;font-weight:normal;margin-bottom:20px;">Thanks,</p>
                            <p style="font-size:14px;font-weight:normal;margin-bottom:20px;">Hover</p>
                            <p style="font-size:14px;font-weight:normal;margin-bottom:20px;">Get help: <a
                                    href="https://help.hover.com/hc/en-us"
                                    style="color:#FFCF00;text-decoration:none;">https://help.hover.com/hc/en-us</a><br>
                                What's happening at Hover: <a href="https://www.hover.com/blog/"
                                    style="color:#FFCF00;text-decoration:none;">https://www.hover.com/blog/</a><br>
                    ...
                    <tr>
                        <td class="content footer" align="center"
                            ...
                            <p style="font-size:14px;font-weight:normal;margin-bottom:20px;">You were sent this email
                                because you are a customer of <a href="https://www.hover.com/">Hover.com</a>.<br>
                                Mailing address: 96 Mowat Ave., Toronto, ON M6K 3M1<br>
                                Email: <a href="mailto:help@hover.com"
                                    style="color:#FFCF00;text-decoration:none;">help@hover.com</a></p>
                        </td>
                    </tr>
                </table>
            </td>
