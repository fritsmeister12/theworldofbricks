{{-- <footer aria-label="Site Footer" class="bg-yellow-400 lg:grid lg:grid-cols-5">
    <div class="relative block h-32 lg:col-span-2 lg:h-96">
        <img src="https://manly.bladecdn.net/wp-content/uploads/2022/11/LEGO-Architecture-Taj-Mahal-21056-uren-bouwplezier-met-fantastich-resultaat.jpg"
            alt="" class="absolute inset-0 object-cover w-full h-full" />
    </div>

    <div class="px-4 py-16 sm:px-6 lg:col-span-3 lg:py-6">
    ...
    <div class="mx-auto max-w-screen-xl px-4 pt-16 pb-6 sm:px-6 lg:px-8 lg:pt-24">
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
                ...
                <p
                    class="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500 text-gray-400 sm:mx-0 sm:max-w-xs sm:text-left">
                    ...
                    <ul class="mt-8 space-y-4 text-sm">
                        <li>
                            <a class="flex items-center justify-center gap-1.5 sm:justify-start" href="/">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0 text-yellow-400"
